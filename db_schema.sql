...
prepare post_form_qa (jsonb, integer) as insert into forms_answers (forms_id, questions_id, answer)   (select $2,  (value->'question_id')::integer, (value->'answer')::text from jsonb_array_elements($1)) on conflict (forms_id, questions_id) do update set answer = excluded.answer;
